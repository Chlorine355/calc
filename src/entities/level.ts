...
export interface Level {
  ...
  operators: string[]
  /**
   * Есть ли у уровня цель. Обучающие (захардкоженные) уровни имеют цель;
   * генерируемые — нет: игрок просто собирает любое выражение.
   */
  hasTarget: boolean
  /**
   ...
   * Значим только если `hasTarget === true`.
   */
  targetScore: number
